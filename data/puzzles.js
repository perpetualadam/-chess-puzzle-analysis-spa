(function(){
  ...
  window.PUZZLES = [
    ...
    { id: 'mate-arabian-1', fen: '7k/6pp/5N2/8/8/8/8/R6K w - - 0 1', side: 'w', rating: 900, themes: ['mate','arabian'], source: 'Composed: Arabian', best: ['Ra8#'], patternTip: 'Rook and knight cooperate: the knight covers the king\'s escape square while the rook delivers mate.' },
    { id: 'mate-arabian-2', fen: '6k1/5ppp/5N2/8/8/8/8/R6K w - - 0 1', side: 'w', rating: 1100, themes: ['mate','arabian'], source: 'Composed: Arabian (variant)', best: ['Ra8#'], patternTip: 'Rook and knight cooperate: the knight covers the king\'s escape square while the rook delivers mate.' },
