(function(){
  ...
  function renderList(){
    ...
    for(const g of GAMELIB){
      ...
      const replay = document.createElement('button'); replay.textContent = 'Replay'; replay.addEventListener('click', ()=> AnalysisMode.loadPGNFromGame(g));
      const puzzle = document.createElement('button'); puzzle.textContent = 'Start Key Puzzle'; puzzle.addEventListener('click', ()=>{
